...
/* ========================================================================= */
local uLong crc32_z_impl(uLong crc, const unsigned char FAR *buf, z_size_t len) {
    /* Return initial CRC, if requested. */
    if (buf == Z_NULL) return 0;
 ...
 * features */
static uLong (*crc32_z_impl_fp)(uLong crc, const unsigned char FAR* buf,
    z_size_t len) = crc32_z_impl;
#endif /* AOCL_ZLIB_OPT */

uLong ZEXPORT crc32_z(uLong crc, const unsigned char FAR* buf,
    z_size_t len) {
    /* Return initial CRC, if requested. */
    if (buf == Z_NULL) return 0;

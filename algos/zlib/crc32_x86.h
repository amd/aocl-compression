...
#include "zconf.h"
#define ZEXTERN_UNIT_TEST ZEXTERN
#define ZEXPORT_UNIT_TEST ZEXPORT
#else
#define ZEXTERN_UNIT_TEST
#define ZEXPORT_UNIT_TEST
#endif
...
crc32_z_c(unsigned long crc, const unsigned char FAR* buf,
    z_size_t len); // reference version for unit testing
#endif
#endif /* _CRC32_X86 */
